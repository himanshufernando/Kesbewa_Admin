...
import tkhub.project.kesbewa.admin.databinding.ListviewRejectOrdersBinding


class RejectOrdersAdapter : ListAdapter<OrderRespons, RecyclerView.ViewHolder>(RejectOrdersDiffCallback()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return OrdersItemViewHolder(ListviewRejectOrdersBinding.inflate(LayoutInflater.from(parent.context), parent, false),mClickListener)
    }
    ...
    class OrdersItemViewHolder(private val binding: ListviewRejectOrdersBinding ,var mClickListener: ClickListener ) :
...
private class RejectOrdersDiffCallback : DiffUtil.ItemCallback<OrderRespons>() {
