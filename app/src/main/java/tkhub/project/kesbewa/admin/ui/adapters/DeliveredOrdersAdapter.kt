...
class DeliveredOrdersAdapter : ListAdapter<OrderRespons, RecyclerView.ViewHolder>(DeliveredOrdersDiffCallback()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return OrdersItemViewHolder(ListviewDeliveredOrdersBinding.inflate(LayoutInflater.from(parent.context), parent, false),mClickListener)
    }
    ...
    class OrdersItemViewHolder(private val binding: ListviewDeliveredOrdersBinding ,var mClickListener: ClickListener ) :
...
private class DeliveredOrdersDiffCallback : DiffUtil.ItemCallback<OrderRespons>() {
