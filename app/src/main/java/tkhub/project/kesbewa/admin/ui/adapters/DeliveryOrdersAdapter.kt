...
class DeliveryOrdersAdapter : ListAdapter<OrderRespons, RecyclerView.ViewHolder>(DeliveryOrdersDiffCallback()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return OrdersItemViewHolder(ListviewDeliveryOrdersBinding.inflate(LayoutInflater.from(parent.context), parent, false),mClickListener)
    }
    ...
    class OrdersItemViewHolder(private val binding: ListviewDeliveryOrdersBinding ,var mClickListener: ClickListener ) :
...
private class DeliveryOrdersDiffCallback : DiffUtil.ItemCallback<OrderRespons>() {
