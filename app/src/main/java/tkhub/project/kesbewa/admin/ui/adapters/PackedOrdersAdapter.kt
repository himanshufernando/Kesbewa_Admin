...
class PackedOrdersAdapter : ListAdapter<OrderRespons, RecyclerView.ViewHolder>(PackedOrdersDiffCallback()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return OrdersItemViewHolder(ListviewPackedOrdersBinding.inflate(LayoutInflater.from(parent.context), parent, false),mClickListener)
    }
    ...
    class OrdersItemViewHolder(private val binding: ListviewPackedOrdersBinding ,var mClickListener: ClickListener ) :
...
private class PackedOrdersDiffCallback : DiffUtil.ItemCallback<OrderRespons>() {
